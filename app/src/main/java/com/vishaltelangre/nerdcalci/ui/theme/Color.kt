...
val MidOutlineDark = Color(0xFF938F99)
val MidOutlineVariantDark = Color(0xFF49454F)
val MidOutlineLight = Color(0xFF79747E)
val MidOutlineVariantLight = Color(0xFFCAC4D0)
...
val SolarOutlineDark = Color(0xFF9C8E80)
val SolarOutlineVariantDark = Color(0xFF4F4539)
val SolarOutlineLight = Color(0xFF847566)
val SolarOutlineVariantLight = Color(0xFFD6C4B1)
...
val ArcticOutlineDark = Color(0xFF8B9294)
val ArcticOutlineVariantDark = Color(0xFF43484A)
val ArcticOutlineLight = Color(0xFF71787A)
val ArcticOutlineVariantLight = Color(0xFFBFCAD1)
...
val NatureOutlineDark = Color(0xFF8D928D)
val NatureOutlineVariantDark = Color(0xFF434843)
val NatureOutlineLight = Color(0xFF727972)
val NatureOutlineVariantLight = Color(0xFFC1CDC1)
...
val RoyalOutlineDark = Color(0xFF9A8E8E)
val RoyalOutlineVariantDark = Color(0xFF514343)
